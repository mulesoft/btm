...
public class PoolingConnectionFactory extends ResourceBean implements ConnectionFactory, XAResourceProducer, PoolingConnectionFactoryMBean {
    ...
    private volatile transient MessagingPooledConnection recoveryPooledConnection;
    ...
    private volatile MessagingConnectionHandle recoveryConnectionHandle;
    ...
    public XAResourceHolderState startRecovery() throws RecoveryException {
        ...
        try {
            recoveryConnectionHandle = (MessagingConnectionHandle) pool.getConnectionHandle(false);
    ...
    public XAStatefulHolder createPooledConnection(Object xaFactory, ResourceBean bean) throws Exception {
        ...
        return new MessagingPooledConnection(this, xaConnection);
    }
