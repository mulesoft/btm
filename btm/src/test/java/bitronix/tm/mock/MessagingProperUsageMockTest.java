 ...
 * @author lorban
 */
public class MessagingProperUsageMockTest extends AbstractMockMessagingTest {

    private final static Logger log = LoggerFactory.getLogger(MessagingProperUsageMockTest.class);
