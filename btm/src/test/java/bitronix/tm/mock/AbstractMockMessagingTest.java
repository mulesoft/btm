...
import bitronix.tm.mock.resource.messaging.MockXAConnectionFactory;
 ...
 * @author lorban
 */
public abstract class AbstractMockMessagingTest extends TestCase {

    private final static Logger log = LoggerFactory.getLogger(AbstractMockMessagingTest.class);
